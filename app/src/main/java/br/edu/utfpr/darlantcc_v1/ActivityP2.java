...
public class ActivityP2 extends AppCompatActivity {
       ...
       /* ActionBar actionBar = getSupportActionBar();
        ...
        botaoProximo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityP3.iniciar(ActivityP2.this,PESSOA,ID);
        ...
        imagem1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ActivityP2.this,
    ...
    public void atualizarResposta(int id){
        ...
        resposta.setR2(String.valueOf(id));
    ...
    public static void iniciar(AppCompatActivity origem, Pessoa pessoa, String id){
        ...
        Intent intent = new Intent(origem, ActivityP2.class);
