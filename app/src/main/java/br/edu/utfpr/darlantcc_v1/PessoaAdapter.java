...
public class PessoaAdapter extends ArrayAdapter<Pessoa> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.linha_pessoa, null);
        }
        ...
        if (i != null) {
            ...
            TextView jrc = (TextView) v.findViewById(R.id.pessoa_rotuloIdade);
            ...
            if (jrn != null){
                jrn.setText("Nome:\t\t\t\t\t" + i.getNOME());
            }
            if (jrc != null){
                jrc.setText("Idade:\t\t\t" + i.getIDADE());
            }
